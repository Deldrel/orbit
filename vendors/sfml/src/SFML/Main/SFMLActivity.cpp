...
{
    // This function reads the value of meta-resources "sfml.app.lib_name"
    ...
    // Get the value of meta-resources named "sfml.app.lib_name"
    ...
    // No meta-resources "sfml.app.lib_name" was found so we abort and inform the user
    if (valueString == NULL)
    {
        LOGE("No meta-resources 'sfml.app.lib_name' found in AndroidManifest.xml file");
        exit(1);
    }
