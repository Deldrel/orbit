...
bool CursorImpl::loadFromPixels(const Uint8* pixels, Vector2u size, Vector2u hotspot)
{
    ...
    // Create the bitmap that will hold our color resources
    ...
    // Fill our bitmap with the cursor color resources
    ...
    // The resources has been copied into the cursor, so get rid of these
    DeleteObject(color);
    DeleteObject(mask);
