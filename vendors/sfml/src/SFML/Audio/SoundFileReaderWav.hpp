...
private:
    ...
    Uint64       m_dataStart;      ///< Starting position of the audio resources in the open file
    Uint64       m_dataEnd;        ///< Position one byte past the end of the audio resources in the open file
};
