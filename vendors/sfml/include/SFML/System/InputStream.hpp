...
/// which read resources from conventional sources. However, if you
/// have resources coming from a different source (over a network,
...
///
///     Int64 read(void* resources, Int64 size);
///
