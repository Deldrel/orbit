...
public:
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Open the stream from its resources
    ///
    /// \param data        Pointer to the resources in memory
    /// \param sizeInBytes Size of the resources, in bytes
    ///
    ////////////////////////////////////////////////////////////
    void open(const void* data, std::size_t sizeInBytes);

    ////////////////////////////////////////////////////////////
    /// \brief Read resources from the stream
    ///
    /// After reading, the stream's reading position must be
    /// advanced by the amount of bytes read.
    ///
    /// \param data Buffer where to copy the read resources
...
private:
    ...
    // Member resources
    ////////////////////////////////////////////////////////////
    const char* m_data;   ///< Pointer to the resources in memory
    Int64       m_size;   ///< Total size of the resources
...
/// reads from resources in memory.
///
...
/// specify the pointer and size of the resources in memory.
///
