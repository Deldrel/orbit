...
{
////////////////////////////////////////////////////////////
/// \brief Abstract base class for capturing sound resources
///
////////////////////////////////////////////////////////////
...
protected:
    ...
    /// recorded resources in real time, for example.
    ///
    ...
    /// recorded resources is available. The derived class can then do
...
/// captured resources to a sound buffer (see sf::SoundBufferRecorder).
///
...
/// the recorded resources in real time, for example.
///
...
/// issues if you share resources between threads.
