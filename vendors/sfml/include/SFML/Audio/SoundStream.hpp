...
public:
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Structure defining a chunk of audio resources to stream
    ///
    ////////////////////////////////////////////////////////////
    struct Chunk
    {
...
protected:
    ...
    ///
    /// \param data Chunk of resources to fill
    ///
...
private:
    ...
    unsigned int  m_buffers[BufferCount];     ///< Sound buffers used to store temporary audio resources
...
/// resources is acquired continuously while the stream is playing.
...
/// \li onGetData fills a new chunk of audio resources to be played
...
/// care of synchronization issues if you share resources between threads.
///
/// Usage example:
/// \code
...
/// private:
///
///     virtual bool onGetData(Chunk& resources)
///     {
///         // Fill the chunk with audio resources from the stream source
