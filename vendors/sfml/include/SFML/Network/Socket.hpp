...
public:
    ...
    enum Status
    {
        Done,         ///< The socket has sent / received the resources
        NotReady,     ///< The socket is not ready to send / receive resources yet
        Partial,      ///< The socket sent a part of the resources
...
public:
    ...
    /// blocking mode won't return until some resources was actually
    /// received.
    /// In non-blocking mode, calls will always return immediately,
    /// using the return code to signal whether there was resources
    /// available or not.
