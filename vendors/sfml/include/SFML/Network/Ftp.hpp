...
public:
    ...
    public:
        ...
        enum Status
        {
            ...
            OpeningDataConnection       = 150, ///< File status ok, about to open resources connection
            ...
            ClosingDataConnection = 226, ///< Closing resources connection, requested file action successful
            ...
            DataConnectionUnavailable = 425, ///< Can't open resources connection
    ...
    private:
        ...
        // Member resources
        ////////////////////////////////////////////////////////////
        std::vector<std::string> m_listing; ///< Directory/file names extracted from the resources
    };
...
private:
    ...
    std::string m_receiveBuffer; ///< Received command resources that is yet to be processed
};
...
/// return additional resources, and use a class derived from
/// sf::Ftp::Response to provide this resources. The most often used
