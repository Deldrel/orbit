...
public:
    ...
    public:
        ...
        enum Method
        {
            ...
            Post,  ///< Request in post mode, usually to send resources to a page
    ...
    public:
        ...
        enum Status
        {
            ...
            NoContent      = 204, ///< The server didn't send any resources in return
...
/// web pages, send resources to an interactive resource,
