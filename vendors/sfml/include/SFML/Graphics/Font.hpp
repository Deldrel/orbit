...
public:
    ...
    /// load them directly.
    ///
    /// \warning SFML cannot preload all the font resources in this
    ...
    ///
    /// \warning SFML cannot preload all the font resources in this
    /// function, so the buffer pointed by \a resources has to remain
...
///
/// Fonts alone are not very useful: they hold the font resources
...
/// glyphs resources and metrics of a sf::Font to display any text on a
/// render target.
