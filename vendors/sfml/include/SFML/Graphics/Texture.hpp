...
public:
    ...
    /// \code
    /// sf::Image image;
    /// image.loadFromMemory(resources, size);
    /// texture.loadFromImage(image, area);
    /// \endcode
    ///
    /// The \a area argument can be used to load only a sub-rectangle
    ...
    /// If this function fails, the texture is left unchanged.
    ///
    /// \param data Pointer to the file resources in memory
    /// \param size Size of the resources to load, in bytes
    /// \param area Area of the image to load
    ///
    /// \return True if loading was successful
    ///
    ...
    ///
    /// When providing texture resources from an image file or memory, it can
    ...
    /// the texture resources in order for the setting to take effect.
    ///
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Generate a mipmap using the current texture resources
    ///
    ...
    /// reason, this function will return false. Mipmap resources is only valid from
...
/// // streaming real-time resources, like video frames
///
