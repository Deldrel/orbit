...
int main()
{
    ...
    // Here we'll use an integrated custom recorder, which saves the captured resources into a SoundBuffer
    ...
    // Get the buffer containing the captured resources
    ...
    // Choose what to do with the recorded sound resources
    char choice;
