...
int main()
{
    ...
    // Staging buffer for our terrain resources that we will upload to our VertexBuffer
        ...
        {
            {
                ...
                if (!pendingWorkCount)
                {
                    // If there is new resources pending to be uploaded to the VertexBuffer, do it now
...
/// of vertices as scratch memory and upload the resources to
